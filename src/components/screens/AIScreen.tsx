  ...
  return (
    <PageLayout>
      ...
      <div className="w-full border-b border-gray-200 bg-white shadow-sm">
        <div className="mx-auto flex max-w-7xl flex-col items-start gap-6 px-4 py-6 md:flex-row md:items-center md:justify-between md:px-8">
          ...
          <div className="mt-4 flex w-full gap-3 md:mt-0 md:hidden">
            ...
            <button onClick={handleShare} className="flex flex-1 items-center justify-center gap-2 rounded bg-[#F57C00] px-4 py-2 text-sm font-bold text-white shadow-sm transition-colors hover:bg-[#E65100]">
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-8 md:px-8 md:py-12">
        <div className="relative flex flex-col gap-8 rounded-xl p-0 md:p-2" style={{ background: "#F5F6FA" }}>
          <div className="relative z-10 px-2 md:px-4">
            <h2 className="mb-4 flex items-center gap-3 text-2xl font-bold" style={{ color: "#1a3c5e" }}>
          ...
          <div className="relative z-10 grid grid-cols-1 items-stretch gap-6 lg:grid-cols-2">
            ...
            <div className="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
              <div className="flex items-center gap-3 rounded-t-xl p-5 text-white" style={{ background: "#2E7D32" }}>
              ...
              <div className="flex flex-grow flex-col gap-6 p-6">
                <div>
                  ...
                  <ul className="mt-4 space-y-3">
                    <li className="flex items-start gap-3 text-[14px] text-gray-500">
                      <svg className="h-5 w-5 shrink-0" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#2E7D32" }}>
                ...
                <div className="mt-auto flex flex-col gap-3 border-t border-gray-200 pt-6">
                  <button onClick={handleFlag} className="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-[#2E7D32] bg-white py-3 font-bold text-[#2E7D32] transition-colors hover:bg-green-50">
            ...
            {/* BuildIt Card */}
            <div className="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm">
              <div className="flex items-center gap-3 rounded-t-xl p-5 text-white" style={{ background: "#F57C00" }}>
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex flex-grow flex-col gap-6 p-6">
                ...
                <div className="mt-auto flex flex-col gap-3 border-t border-gray-200 pt-6">
                  <button onClick={() => setShowGuide(!showGuide)} className="flex w-full items-center justify-center gap-2 rounded-lg py-3 font-bold text-white transition-colors hover:opacity-90" style={{ background: "#F57C00" }}>
                    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          {showGuide && (
            <div className="mx-2 rounded-xl border border-gray-300 bg-white p-6 md:mx-4" style={{ marginTop: "24px" }}>
              <h3 className="mb-4 text-xl font-bold" style={{ color: "#1A3C5E" }}>Full Build Guide</h3>
