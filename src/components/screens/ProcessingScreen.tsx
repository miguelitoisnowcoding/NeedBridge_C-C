        ...
        <div className="flex w-full max-w-lg flex-col items-center gap-8 rounded-xl border border-gray-200 bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="h-[120px] w-[120px]">
            <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M60 10C32.3858 10 10 32.3858 10 60" stroke="#185FA5" strokeLinecap="round" strokeWidth="8">
                <animateTransform
              ...
              <circle cx="60" cy="60" r="15" fill="#185FA5">
          ...
          <div className="w-full space-y-4">
            <div className="flex items-center gap-4">
              <svg className="h-6 w-6" style={{ color: "#185FA5" }} viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="relative h-2 w-full overflow-hidden rounded-full bg-gray-100">
            <div className="absolute top-0 left-0 h-full animate-[loading_4s_ease-in-out_infinite] rounded-full" style={{ background: "#185FA5" }} />
          </div>
        </div>
      </main>

      {/* Footer */}
      <footer style={{ background: "#0C447C" }}>
